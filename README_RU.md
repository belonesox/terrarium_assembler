...
```
* Ваш линукс пользователь должен быть в sudoers, без подтвержения пароля
    * Запустите 

```
   terrarium_assembler systeminstall
```
    * Он скорее всего поставит нужные системные пакеты в ваш линукс (проверено на Ubuntu 22.04 и Fedora)
